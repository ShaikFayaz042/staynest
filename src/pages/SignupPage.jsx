...
function EyeIcon({ open }) {
  return open ? (
    ...
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M17.94 17.94A10.94 10.94 0 0 1 12 20c-7 0-11-8-11-8a19.77 19.77 0 0 1 5.06-5.94M9.9 4.24A10.94 10.94 0 0 1 12 4c7 0 11 8 11 8a19.77 19.77 0 0 1-3.16 4.19" />
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="px-6 py-6">
          ...
          <form className="mt-6 space-y-3" onSubmit={(e) => e.preventDefault()}>
            ...
            <Field icon={mailIcon} type="email" placeholder="Email" value={form.email} onChange={set("email")} />
            <Field
              icon={lockIcon}
          ...
          <p className="text-center text-sm text-gray-600 mt-2">
            ...
            <a to="/login" className="font-semibold" style={{ color: "#FF385C" }}>
              Sign in
            </a>
          </p>
        </div>
