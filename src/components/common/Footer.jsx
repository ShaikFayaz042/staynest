        ...
        <div className="pt-8 flex flex-col gap-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-xs font-medium text-gray-500 dark:text-gray-400 flex flex-wrap justify-center gap-1 md:gap-2">
              ...
              <span className="hover:text-[#FF385C] dark:hover:text-[#FF385C] cursor-pointer">Privacy</span>
              <span className="text-gray-300 dark:text-gray-600">•</span>
              <span className="hover:text-[#FF385C] dark:hover:text-[#FF385C] cursor-pointer">Terms</span>
              <span className="text-gray-300 dark:text-gray-600">•</span>
              <span className="hover:text-[#FF385C] dark:hover:text-[#FF385C] cursor-pointer">Company details</span>
            </div>

            <div className="flex items-center gap-4 text-xs md:text-sm font-medium text-gray-700 dark:text-gray-300">
              <div className="flex items-center gap-1 cursor-pointer hover:text-[#FF385C] dark:hover:text-[#FF385C]">
                <span className="text-base">🌐</span> English (IN)
              </div>
              <span className="text-gray-300 dark:text-gray-600">•</span>
              <div className="cursor-pointer hover:text-[#FF385C] dark:hover:text-[#FF385C]">₹ INR</div>
              <span className="text-gray-300 dark:text-gray-600">•</span>
              <div className="flex items-center gap-3">
                <a href="#" className="hover:text-[#FF385C] dark:hover:text-[#FF385C]" aria-label="Facebook">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
                </a>
                <a href="#" className="hover:text-[#FF385C] dark:hover:text-[#FF385C]" aria-label="X">
                ...
                <a href="#" className="hover:text-[#FF385C] dark:hover:text-[#FF385C]" aria-label="Instagram">
