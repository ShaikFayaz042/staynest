  ...
  return (
    <section className="border-b border-gray-200 dark:border-gray-700 py-8">
      ...
      <div className="grid grid-cols-2 gap-8">
        <div className="flex items-center gap-4 rounded-3xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 shadow-md">
          <div className="text-center">
            ...
            <div className="mt-2 text-xl font-bold text-gray-900 dark:text-white">{host.name}</div>
            <div className="text-xs text-gray-700 dark:text-gray-400">
              <i className="fa-solid fa-medal" /> Superhost
            </div>
          </div>
          <div className="flex-1 space-y-3 border-l border-gray-200 dark:border-gray-700 pl-4 text-sm">
            <div>
              <div className="font-semibold text-gray-900 dark:text-white">{totalReviews}</div>
              <div className="text-xs text-gray-500 dark:text-gray-400">Reviews</div>
            </div>
            <div className="border-t border-gray-200 dark:border-gray-700 pt-2">
              <div className="font-semibold text-gray-900 dark:text-white">{rating > 0 ? `${rating} ★` : "—"}</div>
              <div className="text-xs text-gray-500 dark:text-gray-400">Rating</div>
            </div>
            <div className="border-t border-gray-200 dark:border-gray-700 pt-2">
              <div className="font-semibold text-gray-900 dark:text-white">{yearsHosting}</div>
