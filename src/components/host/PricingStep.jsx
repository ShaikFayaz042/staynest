    ...
    <HostFrame progress={[1, 1, 0.5]} nextDisabled={false}>
      <div className="max-w-2xl mx-auto px-8 md:px-16 py-8">
        ...
        <p className="mt-2 text-gray-600 text-center text-sm">
          ...
          <button className="underline font-semibold hover:text-gray-900">
            Learn more
          </button>
        </p>
        ...
        <div className="mt-8 space-y-4">
          <div className="border border-gray-200 rounded-2xl p-5">
            <div className="text-sm text-gray-500">Base price (per night)</div>
            <div className="flex items-center gap-4 mt-1">
              <button
                onClick={() => updateBasePrice(basePrice - 100)}
                className="w-10 h-10 rounded-full border border-gray-300 text-gray-600 hover:border-black flex items-center justify-center"
              >
                −
              </button>
              <input
                ...
                className="w-32 text-center text-3xl font-extrabold outline-none border-b-2 border-transparent focus:border-black"
                min="1"
                step="100"
              />
              <button
          ...
          <div className="border border-gray-200 rounded-2xl p-5">
            <div className="flex items-end justify-between">
              <div>
                ...
                <div className="flex items-center gap-4 mt-1">
                  ...
                  <input
                    ...
                    className="w-16 text-center text-2xl font-extrabold outline-none border-b-2 border-transparent focus:border-black"
                    min="0"
                    max="100"
                    step="1"
                  />
              ...
              <div className="text-right pb-1">
                ...
                <div className="text-lg font-bold">₹{weekendPrice}</div>
              </div>
            </div>
          </div>
        </div>
