...
export default function HostDashboardPage() {
  ...
  const currentMonth = { month: viewMonth, year: viewYear };
  ...
  const renderCalendar = (month, year) => {
    ...
    return (
      <div className="rounded-3xl border border-gray-200 bg-gray-50 p-3 shadow-sm dark:border-gray-700 dark:bg-gray-900 max-w-[360px] mx-auto">
        <div className="mb-3 flex items-center justify-between gap-2">
          <div>
            <div className="text-base font-semibold text-gray-900 dark:text-white">{MONTH_NAMES[month]} {year}</div>
            <div className="text-xs text-gray-500 dark:text-gray-400">{hostBookings.length > 0 ? `${hostBookings.length} booking${hostBookings.length > 1 ? 's' : ''}` : 'No bookings this month yet'}</div>
          </div>
        </div>

        <div className="grid grid-cols-7 gap-0.5 mb-2 text-center text-[10px] font-semibold text-gray-500 dark:text-gray-400">
      ...
      <main className="max-w-6xl mx-auto px-8 md:px-16 py-12">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-4">
          <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <div className="text-xs uppercase tracking-wide text-gray-500 dark:text-gray-400">Total revenue</div>
        ...
        <div className="mt-8 rounded-3xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Use the Prev and Next buttons to browse months and view booked dates.</p>
            </div>
        ...
        {user ? (
          ...
          <div className="mt-12 text-center text-gray-500 dark:text-gray-400">
            <p className="text-xl">Please log in to view your host dashboard.</p>
          </div>
        )}
      </main>
      <Footer />
